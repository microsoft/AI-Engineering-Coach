...
<div id="app">
  <nav id="sidebar">
    <ul class="nav-links">
      ...
      <li id="team-dashboard-nav" class="nav-hidden"><a href="#" data-page="team-dashboard"><span class="nav-icon"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><circle cx="5" cy="5" r="2.2" stroke="currentColor" stroke-width="1.2"/><circle cx="11" cy="5" r="2.2" stroke="currentColor" stroke-width="1.2"/><path d="M2.5 13c.5-2.2 2.2-3.5 4.5-3.5S11 10.8 11.5 13" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/><path d="M8.5 13c.4-1.8 1.7-2.9 3.4-3.2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg></span> Team Dashboard</a></li>
