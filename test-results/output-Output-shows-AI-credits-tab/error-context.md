...
- Name: output.spec.ts >> Output >> shows AI credits tab
- Location: tests/e2e/output.spec.ts:56:7
...
Call log:
  - waiting for locator('#output-tabs .tab').filter({ hasText: /Credit/i }).first()
